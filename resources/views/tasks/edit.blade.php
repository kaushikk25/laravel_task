    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('task.update', ['id' => encrypt($task->id)]) }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ $task->name }}" name="task" id="task" placeholder="Enter Task Name" required/>
                                @error('task')
